...
Station content SHALL present a heading, a time period or subtitle where the source data has one, and body text, sized and contrasted to be readable at the default camera distance on both desktop and a 360px-wide phone viewport.
...
- **THEN** the text remains legible and is not clipped by the viewport edges
